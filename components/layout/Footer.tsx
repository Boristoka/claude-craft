...
const Footer: React.FC<FooterProps> = ({
  ...
  return (
    <footer className={cn("bg-neutral-900 pt-16 pb-8", className)}>
              ...
              <div className="flex gap-3">
                {socialLinks.linkedin && (
                  <a
                    ...
                    className="w-10 h-10 rounded-lg bg-neutral-800 flex items-center justify-center text-neutral-400 hover:bg-primary-500 hover:text-white transition-colors"
                  >
